...
import { ActionsCell } from '@/app/framework/components/actions-cell';
import GroupDeleteDialog from '@/app/framework/components/delete-group-dialog';
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <ActionsCell
          ...
          EditDialogComponent={ServiceEditDialog}
        />
      ),
      size: 100,
      enableSorting: false,
          ...
          <CardHeader className="py-5">
            <div className="flex items-center gap-2.5">
              ...
              <Input
                ...
                onKeyDown={(e) => e.key === 'Enter' && setPagination({ ...pagination, pageIndex: 0 })}
              />
            ...
            <CardToolbar>
              {deletePermissionIds.length > 0 && (
                ...
                >
                  Delete {deletePermissionIds.length} {_title}
                </Button>
              )}
              <Button
                size="sm"
