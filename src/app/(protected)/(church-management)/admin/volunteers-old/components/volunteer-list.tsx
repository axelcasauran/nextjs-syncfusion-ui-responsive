...
import { Card, CardFooter, CardHeader, CardTable } from '@reui/ui/card';
import {
  DataGrid,
...
import { DataGridTable } from '@reui/ui/data-grid-table';
...
import UserInviteDialog from './volunteer-add-dialog';
import { VolunteerActionsCell } from './volunteer-actions-cell';
  ...
  const columns = useMemo<ColumnDef<User>[]>(
    () => [
      ...
      },
      {
        id: 'actions',
        header: 'Actions',
        cell: ({ row }) => <VolunteerActionsCell row={row} />,
        size: 100,
        enableSorting: false,
        enableHiding: false,
        meta: {
