...
//   getKidStatusProps,
// } from '../constants/kid';
// import { Kid } from '@/app/models/kid';

// export const KidStatusCell = ({
//   row,
// }: {
//   row: Row<Kid>;
// }) => {
...
//   const statusProps = getKidStatusProps(status as EcommerceCategoryStatus);
//   const { id } = row.original;

//   // Mutation for updating status
//   const mutation = useMutation({
//     mutationFn: async (newStatus: string) => {
//       const response = await fetch(`/api/parents/kids/${id}/status`, {
//         method: 'PATCH',
...
//               {KidStatusProps.ACTIVE.label}
//             </DropdownMenuRadioItem>
//             <DropdownMenuRadioItem value="INACTIVE">
//               {KidStatusProps.INACTIVE.label}
//             </DropdownMenuRadioItem>
//           </DropdownMenuRadioGroup>
//         </DropdownMenuContent>
//       </DropdownMenu>
