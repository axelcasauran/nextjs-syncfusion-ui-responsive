      ...
      async profile(profile) {
        ...
        if (existingUser) {
          ...
          return {
            ...
            firstName: existingUser.firstName || 'Anonymous',
            lastName: existingUser.lastName || 'Anonymous',
        ...
        return {
          id: newUser.id,
          email: newUser.email,
          firstName: newUser.firstName || 'Anonymous',
          lastName: newUser.lastName || 'Anonymous',
