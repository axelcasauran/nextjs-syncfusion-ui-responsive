...
import { AccountProfileSchema } from '@user-management-app/account/forms/account-profile-schema';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { firstName, avatarFile, avatarAction } = validationResult.data;
