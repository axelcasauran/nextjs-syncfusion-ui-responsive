...
import {
  UserAddSchema,
  UserAddSchemaType,
} from '@user-management-app/users/forms/user-add-schema';
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const sortMap: Record<string, Prisma.UserOrderByWithRelationInput> = {
      name: { firstName: sortDirection as Prisma.SortOrder },
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { firstName, lastName, email, roleId }: UserAddSchemaType = parsedData.data;
